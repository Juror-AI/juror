...
export const COMPANY_COPY: Record<Locale, CompanyCopy> = {
  en: {
    ...
    summaries: {
      ...
      imprint: 'Company and contact information for Derinbogaz Ventures UG (haftungsbeschränkt), the operator of Juror.',
  ...
  de: {
    ...
    summaries: {
      ...
      imprint: 'Anbieter- und Kontaktangaben der Derinbogaz Ventures UG (haftungsbeschränkt), Betreiberin von Juror.',
  ...
  es: {
    ...
    summaries: {
      ...
      imprint: 'Información y datos de contacto de Derinbogaz Ventures UG (haftungsbeschränkt), la empresa que opera Juror.',
  ...
  ja: {
    ...
    summaries: {
      ...
      imprint: 'Jurorを運営するDerinbogaz Ventures UG (haftungsbeschränkt)の会社情報と連絡先。',
  ...
  'pt-BR': {
    ...
    summaries: {
      ...
      imprint: 'Informações e contato da Derinbogaz Ventures UG (haftungsbeschränkt), empresa que opera o Juror.',
